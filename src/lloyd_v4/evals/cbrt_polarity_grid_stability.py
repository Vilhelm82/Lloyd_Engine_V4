...
from .cbrt_four_form import FORM_KEYS, four_form_float32, four_form_float64
...
DEFAULT_OUTPUT = REPORT_DIR / "cbrt_polarity_grid_stability.json"
POLARITY_CSV = REPORT_DIR / "cbrt_polarity_grid_table.csv"
REGION_CSV = REPORT_DIR / "cbrt_region_split_table.csv"
PRECISION_CSV = REPORT_DIR / "cbrt_precision_overlap_table.csv"
...
def construct_grid(name: str, seed: int) -> dict[str, object]:
    ...
    if name == "reference":
        ...
        return _grid_payload(name, seed, _REF, "canonical cbrt x_grid()", 0, 0)
...
def run_campaign() -> dict[str, object]:
    ...
    return {
        "campaign": "task029c_cbrt_polarity_grid_stability",
        "fixture": "cbrt_chain",
