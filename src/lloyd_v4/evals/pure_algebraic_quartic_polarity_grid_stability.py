...
from .pure_algebraic_quartic_four_form import FORM_KEYS, four_form_float32, four_form_float64


ROOT = Path(__file__).resolve().parents[3]
REPORT_DIR = ROOT / "Build_Docs" / "Reports" / "task032_quartic_lattice_grain_discrimination"
DEFAULT_OUTPUT = REPORT_DIR / "quartic_polarity_grid_stability.json"
...
def construct_grid(name: str, seed: int) -> dict[str, object]:
    ...
    if name == "reference":
        ...
        return _grid_payload(name, seed, _REF, "canonical quartic x_grid()", 0, 0)
...
def run_campaign() -> dict[str, object]:
    ...
    return {
        "campaign": "task032_quartic_polarity_grid_stability",
