...
from .schwarzschild_quartic_four_form import FORM_KEYS, four_form_float32, four_form_float64


ROOT = Path(__file__).resolve().parents[3]
REPORT_DIR = ROOT / "Build_Docs" / "Reports" / "task034_schwarzschild_quartic_transformed_n4"
DEFAULT_OUTPUT = REPORT_DIR / "schwarzschild_quartic_polarity_grid_stability.json"
...
def run_campaign() -> dict[str, object]:
    ...
    return {
        "campaign": "task034_schwarzschild_quartic_polarity_grid_stability",
